...
public class IntJoukkoTest {
    ...
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.kuuluuko(10));
        assertFalse(joukko.kuuluuko(5));
        assertTrue(joukko.kuuluuko(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poista(3);
        assertFalse(joukko.kuuluuko(3));
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertTrue(joukko.kuuluuko(11));
        joukko.poista(11);
        assertFalse(joukko.kuuluuko(11));
